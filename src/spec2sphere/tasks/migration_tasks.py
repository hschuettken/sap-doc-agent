...
def reconcile_brs_task(
    ...
    async def _run():
        from spec2sphere.app import SAPDocAgent
        from spec2sphere.migration.brs_reconciler import reconcile_brs_folder
        from spec2sphere.migration.models import IntentCard
...
def classify_chain_task(
    ...
    async def _run():
        from spec2sphere.app import SAPDocAgent
        from spec2sphere.migration.classifier import ActivityData, classify_chain
        from spec2sphere.migration.models import IntentCard
        from spec2sphere.scanner.models import DataFlowChain
...
def design_target_task(
    ...
    async def _run():
        ...
        from spec2sphere.migration.models import ClassifiedChain
        from spec2sphere.scanner.models import DataFlowChain
...
def generate_sql_task(
    ...
    async def _run():
        ...
        from spec2sphere.migration.models import ViewSpec
