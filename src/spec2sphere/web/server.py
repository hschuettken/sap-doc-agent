...
def create_app(
    ...
    async def atlas_nav_manifest():
        ...
        return {
            ...
            "version": "2.0.0",
            "routes": [
                {"id": "dashboard",        "label": "Dashboard",        "path": "/ui/dashboard",          "category": "Main",     "keywords": ["overview", "status"]},
                {"id": "pipeline",         "label": "Pipeline",         "path": "/ui/pipeline",           "category": "Main",     "keywords": ["delivery", "stages", "approvals"]},
                {"id": "factory",          "label": "Factory",          "path": "/ui/factory",            "category": "Main",     "keywords": ["deploy", "dsp", "sac"]},
                {"id": "reports",          "label": "Reports",          "path": "/ui/reports",            "category": "Main",     "keywords": ["documentation", "browser"]},
                {"id": "landscape",        "label": "Landscape",        "path": "/ui/landscape",          "category": "Discover", "keywords": ["sap", "systems", "graph"]},
                {"id": "scanner",          "label": "Scanner",          "path": "/ui/scanner",            "category": "Discover", "keywords": ["scan", "crawl", "discovery"]},
                {"id": "objects",          "label": "Objects",          "path": "/ui/objects",            "category": "Discover", "keywords": ["cdp", "dsp", "artifacts"]},
                {"id": "graph",            "label": "Dependencies",     "path": "/ui/graph",              "category": "Discover", "keywords": ["dependencies", "relations"]},
                {"id": "knowledge",        "label": "Knowledge",        "path": "/ui/knowledge",          "category": "Discover", "keywords": ["knowledge base", "standards"]},
                {"id": "quality",          "label": "Quality",          "path": "/ui/quality",            "category": "Quality",  "keywords": ["rules", "assessment"]},
                {"id": "reconciliation",   "label": "Reconciliation",   "path": "/ui/reconciliation",     "category": "Quality",  "keywords": ["validate", "data"]},
                {"id": "visual-qa",        "label": "Visual QA",        "path": "/ui/visual-qa",          "category": "Quality",  "keywords": ["screenshot", "visual testing"]},
                {"id": "audit",            "label": "Audit",            "path": "/ui/audit",              "category": "Quality",  "keywords": ["audit", "review"]},
                {"id": "audit-log",        "label": "Audit Log",        "path": "/ui/audit-log",          "category": "Quality",  "keywords": ["log", "history"]},
                {"id": "lab",              "label": "Lab",              "path": "/ui/lab",                "category": "Learning", "keywords": ["learning", "templates"]},
                {"id": "lab-fitness",      "label": "Route Fitness",    "path": "/ui/lab/fitness",        "category": "Learning", "keywords": ["fitness", "metrics"]},
                {"id": "design-tokens",    "label": "Design Tokens",    "path": "/ui/design-tokens",      "category": "Learning", "keywords": ["design", "tokens"]},
                {"id": "agent-terminal",   "label": "Agent Terminal",   "path": "/ui/agent-terminal",     "category": "System",   "keywords": ["terminal", "tmux", "sessions"]},
                {"id": "migration",        "label": "Migration",        "path": "/ui/migration/projects", "category": "System",   "keywords": ["legacy", "migration", "projects"]},
                {"id": "llm-routing",      "label": "LLM Routing",      "path": "/ui/llm-routing",        "category": "System",   "keywords": ["llm", "provider", "routing"]},
                {"id": "notifications",    "label": "Notifications",    "path": "/ui/notifications",      "category": "System",   "keywords": ["alerts", "notifications"]},
                {"id": "settings",         "label": "Settings",         "path": "/ui/settings",           "category": "System",   "keywords": ["config", "settings"]},
                {"id": "admin",            "label": "Admin",            "path": "/ui/admin",              "category": "System",   "keywords": ["admin", "management"]},
                {"id": "ai-studio",        "label": "AI Studio",        "path": "/ai-studio/",            "category": "Tools",    "keywords": ["ai", "prompts", "authoring"]},
                {"id": "copilot",          "label": "Copilot Hub",      "path": "/copilot",               "category": "Tools",    "keywords": ["copilot", "knowledge", "m365"]},
            ],
            "shortcuts": [
                {"key": "g d", "description": "Go to Dashboard",   "action": "dashboard"},
                {"key": "g p", "description": "Go to Pipeline",    "action": "pipeline"},
                {"key": "g f", "description": "Go to Factory",     "action": "factory"},
                {"key": "g o", "description": "Go to Objects",     "action": "objects"},
                {"key": "g s", "description": "Go to Scanner",     "action": "scanner"},
                {"key": "g q", "description": "Go to Quality",     "action": "quality"},
            ],
        }
