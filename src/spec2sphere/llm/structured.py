...
async def generate_json_with_retry(
    ...
    Args:
        tier: Model tier — "small", "medium", "large", or "reasoning".
              Defaults to "large" (prefer quality over speed).
        data_in_context: True if the prompt contains customer data (SQL, ABAP, BRS docs, etc.).
    """
